...
% run name for plots
pname = 'CO2, 17 Nov 2023 PH side 1';
...
% gas file and weight
opt.abswt = 12.69;
% nominal log values 50.1 Torr, 17.4 C
...
igm.ET1 = igm.ET1(:, :, 521:845);
igm.ET2 = igm.ET2(:, :, 618:942);
igm.FT2 = igm.FT2(:, :, 421:736);
igm.FT1 = igm.FT1(:, :, 358:682);
