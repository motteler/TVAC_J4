...
% run name for plots
pname = 'CH4, 18 Nov 2023 PH side 1';
...
% gas file and weight
opt.abswt = 12.69;
% nominal log values 50.0 Torr, 17.3 C
opt.afile = 'lblr_CH4_50p00_Torr_16p90_C';
...
igm.ET1 = igm.ET1(:, :, 671:986);
igm.ET2 = igm.ET2(:, :, 361:685);
igm.FT2 = igm.FT2(:, :, 615:939);
igm.FT1 = igm.FT1(:, :, 489:795);
