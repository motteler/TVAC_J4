...
% run name for plots
pname = 'CO, 10 Dec 2023 MN side 1';
...
% opts.gfile = '../gas_calcs/lblr_CO_49p58_Torr_17p15_C';
  opts.gfile = '../gas_calcs/lblr_CO_50p06_Torr_15p57_C';
opts.gc = load(opts.gfile);

% obs parameters
opts.sdir = 0;
opts.sfile = '../inst_data/SAinv_default_HR4_SW';

% specify the ES subsets
% values are for the 12-10_mn_s1_CO test
igm  = struct;
igm.et1_ix = 310:630;
igm.et2_ix = 650:977;
igm.ft2_ix = 565:885;
