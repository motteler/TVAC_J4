...
opt2 = struct;
  opt2.neonWL = 703.44765;  % Larrabee's J3 value
% opt2.neonWL = 703.43586;  % value from eng
...
% run name for plots
pname = 'CO2, 9 Dec 2023 MN side 1';
...
% gas file and weight
opt.abswt = 12.69;
% nominal log values 50.0 Torr, 17.5 C
opt.afile = 'lblr_CO2_49p75_Torr_17p27_C';
...
igm.ET1 = igm.ET1(:, :, 612:936);
igm.ET2 = igm.ET2(:, :, 688:1012);
igm.FT2 = igm.FT2(:, :, 113:437);
igm.FT1 = igm.FT1(:, :, 270:594);
