...
% run name for plots
pname = 'CH4, 11 Nov 2023 PL side 1';
...
% gas file and weight
opt.abswt = 12.69;
opt.afile = 'lblr_CH4_50p00_Torr_15p63_C';
...
igm.ET1 = igm.ET1(:, :, 291:615);
igm.ET2 = igm.ET2(:, :, 543:867);
igm.FT2 = igm.FT2(:, :, 308:632);
igm.FT1 = igm.FT1(:, :, 688:1012);
